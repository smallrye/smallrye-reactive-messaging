...
[source,java]
----
include::../examples/snippets/ProcessorExamples.java[tag=processor]
----
...
[source,java]
----
include::../examples/snippets/ProcessorExamples.java[tag=filtering-processor]
----
...
[source,java]
----
include::../examples/snippets/ProcessorExamples.java[tag=return-processor]
----

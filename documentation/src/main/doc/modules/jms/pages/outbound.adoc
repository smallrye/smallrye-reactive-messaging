...
When sending `Messages`, you can add an instance of `io.smallrye.reactive.messaging.jms.OutgoingJmsMessageMetadata` to influence how the message is going to written to JMS.

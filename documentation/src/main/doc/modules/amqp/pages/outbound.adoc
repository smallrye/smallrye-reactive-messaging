...
[source, java]
----
include::example$outbound/AmqpOutboundDynamicAddressExample.java[tag=code]
----
...
More details about the AMQP Address model can be found on https://activemq.apache.org/components/artemis/documentation/2.0.0/address-model.html[the Artemis documentation].
...
[source, java]
----
include::example$outbound/AmqpCloudEventProcessor.java[]
----
...
[source, java]
----
include::example$outbound/AmqpCloudEventMultipleProcessors.java[]
----

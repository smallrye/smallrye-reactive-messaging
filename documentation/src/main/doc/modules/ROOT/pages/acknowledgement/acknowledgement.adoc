...
The {javadoc-base}/org/eclipse/microprofile/reactive/messaging/Acknowledgment.html[`Acknowledgment`] annotation lets you customize the default strategy that have been covered in the previous sections.

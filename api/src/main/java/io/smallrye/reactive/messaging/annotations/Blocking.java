...
public @interface Blocking {
     ...
     * message ordering, or run in parallel with messages being emitted in the order
     ...
     * executions are run in parallel on worker threads and may finish in a different
     ...
     * by blocking methods running in parallel, or of output messages subsequently emitted
     * is not preserved.
     *

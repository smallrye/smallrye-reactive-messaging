...
public class MqttSource {
  ...
  public MqttSource(Vertx vertx, Config config) {
    ...
    String host = config.getOptionalValue("host", String.class).orElseThrow(() ->
      new NoSuchElementException("Invalid configuration - expected key `host` to be present in " + config.getPropertyNames())
    );

...
@ConnectorAttribute(name = "will-flag", type = "boolean", direction = INCOMING_AND_OUTGOING, description = "Ignored: the will message is sent by the broker as soon as `will-topic` and `will-payload` are set", defaultValue = "false")
...
@ConnectorAttribute(name = "will-topic", type = "string", direction = INCOMING_AND_OUTGOING, description = "Set the topic of the will message, to be set together with `will-payload`")
@ConnectorAttribute(name = "will-payload", type = "string", direction = INCOMING_AND_OUTGOING, description = "Set the payload of the will message, to be set together with `will-topic`")
@ConnectorAttribute(name = "will-content-type", type = "string", direction = INCOMING_AND_OUTGOING, description = "Set the content type of the will payload (MQTT 5.0 only)")
@ConnectorAttribute(name = "will-response-topic", type = "string", direction = INCOMING_AND_OUTGOING, description = "Set the response topic of the will message (MQTT 5.0 only)")
@ConnectorAttribute(name = "will-delay-interval", type = "long", direction = INCOMING_AND_OUTGOING, description = "Set the will delay interval in seconds (MQTT 5.0 only)")
...
@ConnectorAttribute(name = "receive-maximum", type = "int", direction = INCOMING_AND_OUTGOING, description = "Set the maximum number of QoS 1 and QoS 2 publications the client is willing to process concurrently (MQTT 5.0 only)")
@ConnectorAttribute(name = "topic-alias-maximum", type = "int", direction = INCOMING_AND_OUTGOING, description = "Set the highest value the client accepts as a topic alias sent by the broker (MQTT 5.0 only)")

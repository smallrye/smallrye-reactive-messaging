...
public class DynamicMqttTopicSourceTest extends MqttTestBase {
    ...
    private void awaitAndVerify() {
        ...
        io.smallrye.reactive.messaging.mqtt.MqttConnector connector = this.container
                .select(io.smallrye.reactive.messaging.mqtt.MqttConnector.class, ConnectorLiteral.of("smallrye-mqtt")).get();

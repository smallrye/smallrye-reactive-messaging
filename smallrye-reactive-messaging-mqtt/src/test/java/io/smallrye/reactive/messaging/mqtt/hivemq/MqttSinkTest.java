...
import io.smallrye.reactive.messaging.mqtt.ProducingBean;
...
public class MqttSinkTest extends MqttTestBase {
    ...
    public void cleanup() {
        ...
        io.smallrye.reactive.messaging.mqtt.Clients.clear();
    }
    ...
    public void testSinkUsingInteger() throws InterruptedException {
        ...
        io.smallrye.reactive.messaging.mqtt.MqttSink sink = new io.smallrye.reactive.messaging.mqtt.MqttSink(vertx, new io.smallrye.reactive.messaging.mqtt.MqttConnectorOutgoingConfiguration(new MapBasedConfig(config)));

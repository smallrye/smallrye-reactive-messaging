...
@ConnectorAttribute(name = "pause-after-inactivity", type = "int", direction = Direction.INCOMING, description = "Duration in seconds after which the underlying Kafka consumer is paused if there is no requests. The consumer is resumed at the next request. 0 disables this feature.", defaultValue = "5")

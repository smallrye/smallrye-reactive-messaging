 ...
 */
public class KafkaSinkWithLegacyMetadataTest extends KafkaCompanionTestBase {
    ...
    public void testInvalidPayloadType() {
        ...
        assertThat(consumed.awaitCompletion(Duration.ofMinutes(1)).count()).isEqualTo(4); // 3 and 5 are ignored.
    ...
    @Test
    public void testABeanProducingRecordsNoValueNoKey() {
        ConsumerTask<Integer, String> consumed = companion.consume(Integer.class, String.class)
                .fromTopics(topic, 10);

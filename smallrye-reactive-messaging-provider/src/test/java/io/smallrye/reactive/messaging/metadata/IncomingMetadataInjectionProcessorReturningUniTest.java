...
public class IncomingMetadataInjectionProcessorReturningUniTest extends WeldTestBaseWithoutTails {
    ...
    void testMetadataInjectingInProcessorIngestingPayload() {
        ...
        initialize();
        IncomingMetadataInjectionProcessorReturningUniTest.Sink sink = container
                .select(IncomingMetadataInjectionProcessorReturningUniTest.Sink.class).get();
    ...
    public static class ProcessorIngestingPayload {
        @Incoming("source")
        @Outgoing("sink")
        public Uni<String> process(String p, SimplePropagationTest.MsgMetadata metadata) {
    ...
    public static class ProcessorIngestingPayloadWithOptional {
        @Incoming("source")
        @Outgoing("sink")
        public Uni<String> process(String p, Optional<SimplePropagationTest.MsgMetadata> metadata) {
            assertThat(p).isNotNull();

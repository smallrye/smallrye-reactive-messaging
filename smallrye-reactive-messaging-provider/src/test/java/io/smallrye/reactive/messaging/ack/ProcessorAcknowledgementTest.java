...
import static io.smallrye.reactive.messaging.ack.BeanWithProcessors.*;
...
public class ProcessorAcknowledgementTest extends WeldTestBaseWithoutTails {
  ...
  public void testManualAcknowledgement() {
    weld.addBeanClass(BeanWithProcessors.class);
    WeldContainer container = weld.initialize();
    BeanWithProcessors bean = container.getBeanManager().createInstance().select(BeanWithProcessors.class).get();

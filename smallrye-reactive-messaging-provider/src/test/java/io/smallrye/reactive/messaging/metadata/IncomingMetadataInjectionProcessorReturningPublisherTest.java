...
public class IncomingMetadataInjectionProcessorReturningPublisherTest extends WeldTestBaseWithoutTails {
    ...
    void testMetadataInjectingInProcessorIngestingPayload() {
        ...
        initialize();
        IncomingMetadataInjectionProcessorReturningPublisherTest.Sink sink = container
                .select(IncomingMetadataInjectionProcessorReturningPublisherTest.Sink.class).get();
    ...
    public static class ProcessorIngestingPayload {
        @Incoming("source")
        @Outgoing("sink")
        public Flow.Publisher<String> process(String p, SimplePropagationTest.MsgMetadata metadata) {
    ...
    public static class ProcessorIngestingPayloadWithOptional {
        @Incoming("source")
        @Outgoing("sink")
        public Flow.Publisher<String> process(String p, Optional<SimplePropagationTest.MsgMetadata> metadata) {
            assertThat(p).isNotNull();

...
public class IncomingMetadataInjectionSubscriberReturningUniTest extends WeldTestBaseWithoutTails {
    ...
    public static class SubscriberIngestingPayload extends DefaultSink {
        ...
        @Incoming("source")
        public Uni<Void> process(String p, SimplePropagationTest.MsgMetadata metadata) {
    ...
    public static class SubscriberIngestingPayloadWithOptional extends DefaultSink {
        @Incoming("source")
        public Uni<Void> process(String p, Optional<SimplePropagationTest.MsgMetadata> metadata) {
            assertThat(p).isNotNull();

...
public class IncomingMetadataInjectionProcessorReturningCSTest extends WeldTestBaseWithoutTails {
    ...
    void testMetadataInjectingInProcessorIngestingPayload(Class<?> processor) {
        ...
        initialize();
        IncomingMetadataInjectionProcessorReturningCSTest.Sink sink = container
                .select(IncomingMetadataInjectionProcessorReturningCSTest.Sink.class).get();
    ...
    public static class ProcessorIngestingPayload {
        @Incoming("source")
        @Outgoing("sink")
        public CompletionStage<String> process(String p, SimplePropagationTest.MsgMetadata metadata) {
    ...
    public static class ProcessorIngestingPayloadWithOptional {
        @Incoming("source")
        @Outgoing("sink")
        public CompletionStage<String> process(String p, Optional<SimplePropagationTest.MsgMetadata> metadata) {
            assertThat(p).isNotNull();

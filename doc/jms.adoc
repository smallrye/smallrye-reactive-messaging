...
You can customize the _routing_ and the content of the outgoing JMS message by adding the following metadata to the `Message` you produce:
...
The incoming message contain the following metadata:

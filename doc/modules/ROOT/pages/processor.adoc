...
[source,java]
----
include::example$ProcessorExamples.java[tag=processor]
----
...
[source,java]
----
include::example$ProcessorExamples.java[tag=filtering-processor]
----
...
[source,java]
----
include::example$ProcessorExamples.java[tag=return-processor]
----

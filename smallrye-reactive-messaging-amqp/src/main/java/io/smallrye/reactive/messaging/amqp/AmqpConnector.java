...
@ConnectorAttribute(name = "initial-credits", direction = INCOMING, description = "The number of credits initially requested for incoming messages. This controls how many messages the receiver can buffer.", type = "int", defaultValue = "1000")
